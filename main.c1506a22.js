(this.ordle = this.ordle || {}),
  (this.ordle.bundle = (function (e) {
    ...
    var La = ordleSolutionWordsArray,
      Ta = ordleAllWordsArray,
      Ia = "present",
      Ma = "correct",
      Oa = "absent";
    ...
    var Za = "IN_PROGRESS",
      es = "WIN",
      as = "FAIL",
      ss = ["Flaks eller juks...", "Godkjent under tvil", "Imponerende", "Helmaks", "Godt jobba", "Skammelig"],
      ts = (function (e) {
        r(t, e);
        var a = h(t);
                  ...
                  p.appendChild(m),
                    this.shadowRoot.querySelector("button#share-button").addEventListener("click", function (a) {
                      ...
                      As(
                        ...
                        function () {
                          e.gameApp.addToast("Kopierte resultatet til utklippstavla", 2e3, !0);
                        },
                        function () {
                          e.gameApp.addToast("Deling feilet", 2e3, !0);
                        }
                      );
                    });
                }
